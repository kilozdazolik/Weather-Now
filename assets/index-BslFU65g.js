      ...
      <li class="sidebar-list-item">
        <div class="sidebar-list-item_left">
          <img
            ...
            src="./public/images/icon-${_(u.code)}.webp"
            alt="weather icon"
          />
